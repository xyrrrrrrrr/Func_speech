...
***********************************/
	...
	else if(str1 == str17)
	{
		...
		system("dbus-launch gnome-terminal -- roslaunch xf_mic_asr_offline_line voi_visual_follower.launch");//打开视觉跟随节点
	...
	else if(str1 == str20)
	{
		...
		system("dbus-launch gnome-terminal -- roslaunch xf_mic_asr_offline_line voi_rrt_slam.launch");//打开自主建图功能
		cout<<"好的：打开自主建图"<<endl;
	...
	else if(str1 == str22)
	{
		...
		system("dbus-launch gnome-terminal -- roslaunch xf_mic_asr_offline_line voi_navigation.launch");//打开导航节点
		system("dbus-launch gnome-terminal -- roslaunch xf_mic_asr_offline_line send_mark.launch");//打开多点巡航脚本
		cout<<"好的：小车开始导航"<<endl;
	}
	else{
		OTHER = (char*) "/feedback_voice/OK.wav";
