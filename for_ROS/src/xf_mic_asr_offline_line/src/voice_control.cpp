...
int main(int argc, char *argv[])
{
	...
	ndHandle.param("source_path", source_path, std::string("/home/wheeltec/wheeltec_robot/src/vvui_ros-master/xf_mic_asr_offline_line"));
	ndHandle.param("/appid", appid, std::string("0fdbf520"));//appid，需要更换为自己的
