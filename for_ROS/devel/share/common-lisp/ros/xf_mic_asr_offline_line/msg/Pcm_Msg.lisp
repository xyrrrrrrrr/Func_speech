...
(cl:defmethod cl:initialize-instance :after ((m <Pcm_Msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pcm_Msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_line-msg:<Pcm_Msg> is deprecated: use xf_mic_asr_offline_line-msg:Pcm_Msg instead.")))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <Pcm_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-msg:length-val is deprecated.  Use xf_mic_asr_offline_line-msg:length instead.")
  (length m))

(cl:ensure-generic-function 'pcm_buf-val :lambda-list '(m))
(cl:defmethod pcm_buf-val ((m <Pcm_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-msg:pcm_buf-val is deprecated.  Use xf_mic_asr_offline_line-msg:pcm_buf instead.")
  (pcm_buf m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Pcm_Msg>)))
  ...
  "xf_mic_asr_offline_line/Pcm_Msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Pcm_Msg)))
  "Returns string type for a message object of type 'Pcm_Msg"
  "xf_mic_asr_offline_line/Pcm_Msg")
