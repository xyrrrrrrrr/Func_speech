...
(cl:in-package xf_mic_asr_offline_line-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_line-msg:<position> is deprecated: use xf_mic_asr_offline_line-msg:position instead.")))

(cl:ensure-generic-function 'angleX-val :lambda-list '(m))
(cl:defmethod angleX-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-msg:angleX-val is deprecated.  Use xf_mic_asr_offline_line-msg:angleX instead.")
  (angleX m))

(cl:ensure-generic-function 'angleY-val :lambda-list '(m))
(cl:defmethod angleY-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-msg:angleY-val is deprecated.  Use xf_mic_asr_offline_line-msg:angleY instead.")
  (angleY m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-msg:distance-val is deprecated.  Use xf_mic_asr_offline_line-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<position>)))
  ...
  "xf_mic_asr_offline_line/position")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position)))
  "Returns string type for a message object of type 'position"
  "xf_mic_asr_offline_line/position")
