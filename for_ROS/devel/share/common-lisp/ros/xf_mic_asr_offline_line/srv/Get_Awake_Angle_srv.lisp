...
(cl:in-package xf_mic_asr_offline_line-srv)
...
(cl:defclass <Get_Awake_Angle_srv-request> (roslisp-msg-protocol:ros-message)
  ((get_awake_angle
    :reader get_awake_angle
    :initarg :get_awake_angle
    :type cl:fixnum
    :initform 0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Get_Awake_Angle_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Get_Awake_Angle_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_line-srv:<Get_Awake_Angle_srv-request> is deprecated: use xf_mic_asr_offline_line-srv:Get_Awake_Angle_srv-request instead.")))

(cl:ensure-generic-function 'get_awake_angle-val :lambda-list '(m))
(cl:defmethod get_awake_angle-val ((m <Get_Awake_Angle_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-srv:get_awake_angle-val is deprecated.  Use xf_mic_asr_offline_line-srv:get_awake_angle instead.")
  (get_awake_angle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Get_Awake_Angle_srv-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'get_awake_angle)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Get_Awake_Angle_srv-request>) istream)
  "Deserializes a message object of type '<Get_Awake_Angle_srv-request>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'get_awake_angle) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Get_Awake_Angle_srv-request>)))
  ...
  "xf_mic_asr_offline_line/Get_Awake_Angle_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Awake_Angle_srv-request)))
  "Returns string type for a service object of type 'Get_Awake_Angle_srv-request"
  "xf_mic_asr_offline_line/Get_Awake_Angle_srvRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Get_Awake_Angle_srv-request>)))
  ...
  "e9e10e1054cdfc6d195484df5648e04e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Get_Awake_Angle_srv-request)))
  "Returns md5sum for a message object of type 'Get_Awake_Angle_srv-request"
  "e9e10e1054cdfc6d195484df5648e04e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Get_Awake_Angle_srv-request>)))
  ...
  (cl:format cl:nil "int8 get_awake_angle #1,0~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Get_Awake_Angle_srv-request)))
  "Returns full string definition for message of type 'Get_Awake_Angle_srv-request"
  (cl:format cl:nil "int8 get_awake_angle #1,0~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Get_Awake_Angle_srv-request>))
  ...
  (cl:list 'Get_Awake_Angle_srv-request
    (cl:cons ':get_awake_angle (get_awake_angle msg))
))
...
(cl:defmethod cl:initialize-instance :after ((m <Get_Awake_Angle_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Get_Awake_Angle_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline_line-srv:<Get_Awake_Angle_srv-response> is deprecated: use xf_mic_asr_offline_line-srv:Get_Awake_Angle_srv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Get_Awake_Angle_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-srv:result-val is deprecated.  Use xf_mic_asr_offline_line-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'awake_angle-val :lambda-list '(m))
(cl:defmethod awake_angle-val ((m <Get_Awake_Angle_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-srv:awake_angle-val is deprecated.  Use xf_mic_asr_offline_line-srv:awake_angle instead.")
  (awake_angle m))

(cl:ensure-generic-function 'fail_reason-val :lambda-list '(m))
(cl:defmethod fail_reason-val ((m <Get_Awake_Angle_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline_line-srv:fail_reason-val is deprecated.  Use xf_mic_asr_offline_line-srv:fail_reason instead.")
  (fail_reason m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Get_Awake_Angle_srv-response>)))
  ...
  "xf_mic_asr_offline_line/Get_Awake_Angle_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Awake_Angle_srv-response)))
  "Returns string type for a service object of type 'Get_Awake_Angle_srv-response"
  "xf_mic_asr_offline_line/Get_Awake_Angle_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Get_Awake_Angle_srv)))
  ...
  "xf_mic_asr_offline_line/Get_Awake_Angle_srv")