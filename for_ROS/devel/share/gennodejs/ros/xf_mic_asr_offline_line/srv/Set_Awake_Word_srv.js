...
class Set_Awake_Word_srvRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.awake_word);
    return length + 4;
  }

  static datatype() {
    // Returns string type for a service object
    return 'xf_mic_asr_offline_line/Set_Awake_Word_srvRequest';
  }
...
class Set_Awake_Word_srvResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'xf_mic_asr_offline_line/Set_Awake_Word_srvResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'xf_mic_asr_offline_line/Set_Awake_Word_srv'; }
};
