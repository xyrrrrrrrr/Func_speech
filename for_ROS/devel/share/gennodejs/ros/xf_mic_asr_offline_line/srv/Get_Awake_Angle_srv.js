...
// (in-package xf_mic_asr_offline_line.srv)
...
class Get_Awake_Angle_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int8(obj.get_awake_angle, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.get_awake_angle = _deserializer.int8(buffer, bufferOffset);
    return data;
  }
...
class Get_Awake_Angle_srvResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'xf_mic_asr_offline_line/Get_Awake_Angle_srvResponse';
  }
...
module.exports = {
  ...
  md5sum() { return 'e9e10e1054cdfc6d195484df5648e04e'; },
  datatype() { return 'xf_mic_asr_offline_line/Get_Awake_Angle_srv'; }
};
