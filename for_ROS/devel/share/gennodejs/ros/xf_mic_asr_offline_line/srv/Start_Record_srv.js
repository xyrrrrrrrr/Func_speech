...
class Start_Record_srvRequest {
  ...
  static datatype() {
    ...
    return 'xf_mic_asr_offline_line/Start_Record_srvRequest';
  }
...
class Start_Record_srvResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'xf_mic_asr_offline_line/Start_Record_srvResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'xf_mic_asr_offline_line/Start_Record_srv'; }
};
