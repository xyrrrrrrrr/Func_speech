...
int main(int argc, char* argv[])
{
	...
	const char *  lgi_param     = "appid = 0fdbf520";
	...
	category = read_syllable_cn ;
	switch(category)
	{
	case read_syllable_cn:
		ise_ssb_param = "sub=ise,plev=0,ent=cn_vip,category=read_syllable,language=zh_cn,aue=speex-wb;7,auf=audio/L16;rate=16000";
		//f_txt = fopen("./ise_cn/cn_syll.txt", "rb+");
		f_txt = fopen("./ise_cn/cn_syll2.txt", "rb+");//无拼音标注
		f_pcm = fopen("./ise_cn/cn_syll.wav", "rb+");
		break;
	case read_word_cn:
		ise_ssb_param = "sub=ise,plev=0,ent=cn_vip,category=read_word,language=zh_cn,aue=speex-wb;7,auf=audio/L16;rate=16000";
		f_txt = fopen("./ise_cn/cn_word.txt", "rb+");
		f_pcm = fopen("./ise_cn/cn_word.wav", "rb+");
		break;
	case read_sentence_cn:
		ise_ssb_param = "sub=ise,plev=0,ent=cn_vip,category=read_sentence,language=zh_cn,aue=speex-wb;7,auf=audio/L16;rate=16000";
		f_txt = fopen("./ise_cn/cn_sentence.txt", "rb+");
		f_pcm = fopen("./ise_cn/cn_sentence.wav", "rb+");
		break;
	case read_word_en:
		ise_ssb_param = "sub=ise,plev=0,ent=en_vip,category=read_word,language=en_us,aue=speex-wb;7,auf=audio/L16;rate=16000";
		f_txt = fopen("./ise_en/en_word.txt", "rb+");
		f_pcm = fopen("./ise_en/en_word.wav", "rb+");
		break;
	case read_sentence_en:
		ise_ssb_param = "sub=ise,plev=0,ent=en_vip,category=read_sentence,language=en_us,aue=speex-wb;7,auf=audio/L16;rate=16000";
