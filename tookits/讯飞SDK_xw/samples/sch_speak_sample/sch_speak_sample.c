...
int main(int argc, char* argv[])
{
	...
	const char* login_params			=	"appid = 0fdbf520"; // 登录参数，appid与msc库绑定,请勿随意改动
	...
	* sch:              是否使用语义标识
	*/
	const char* session_begin_params ="nlp_version =3.0,scene = main,sch=1,sub=iat,domain = iat, language = zh_cn, accent = mandarin,aue = speex-wb;7, sample_rate = 16000, result_type = plain, result_encoding = utf8";
